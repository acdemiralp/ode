...
__constant__ constexpr auto tableau_a                    <dormand_prince_5_tableau<type>> = std::array
{ 
  type(    1.0 /    5.0),
...
template <typename type>
__constant__ constexpr auto tableau_b                    <dormand_prince_5_tableau<type>> = std::array
{
  type(  35.0 /   384.0), type(0.0), type( 500.0 /  1113.0), type(125.0 / 192.0), type(- 2187.0 /   6784.0), type( 11.0 /   84.0), type(0.0)
};
template <typename type>
__constant__ constexpr auto tableau_bs                   <dormand_prince_5_tableau<type>> = std::array
{
  type(5179.0 / 57600.0), type(0.0), type(7571.0 / 16695.0), type(393.0 / 640.0), type(-92097.0 / 339200.0), type(187.0 / 2100.0), type(1.0 / 40.0)
};
template <typename type>
__constant__ constexpr auto tableau_c                    <dormand_prince_5_tableau<type>> = std::array
{
